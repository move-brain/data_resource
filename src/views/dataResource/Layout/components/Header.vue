<template>
  <div class="all">
    <el-row>
      <el-col :span="5">
        <div
          class="header_left cursor-pointer"
          @click="clickdataresuore"
          style="width: 100%"
        >
      ...
      <el-col :span="14">
        <el-menu
          ...
          @select="activeid"
        >
          <el-menu-item v-for="(item, index) in headermenu" :index="item.id">{{
            item.label
          }}</el-menu-item>
        </el-menu>
      </el-col>
      <el-col :span="5">
        ...
        >
          ...
          >
            ...
            <div class="line"></div>
            <div @click="goregister" class="register hover:text-[#007f99]">
              注册
            </div>
          </div>
          <div v-else class="mr-5">
            <el-select class="applySelect" placeholder="ggbond">
              <el-option
                v-for="item in 2"
                :key="item"
                :label="item"
