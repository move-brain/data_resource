    ...
    onMounted(() => {
        ...
        series: [
          {
            ...
            color: "rgb(19, 161, 191)",
            symbol: "none",
          },
          {
            name: "图例2",
            type: "line",
            data: [180, 182, 191, 199, 204, 210, 213, 216, 230, 252, 286, 309],
            color: "rgb(243, 164, 84)",
            symbol: "none",
          },
          {
            name: "图例3",
            type: "line",
            data: [280, 262, 271, 272, 272, 270, 267, 277, 278, 279, 276, 271],
            color: "rgb(118, 132, 161)",
            symbol: "none",
          },
          {
            name: "图例4",
            type: "line",
            data: [330, 392, 411, 384, 360, 367, 375, 355, 365, 370, 405, 392],
            color: "rgb(92, 137, 230)",
            symbol: "none",
          },
        ],
      });
        ...
        xAxis: [
          {
            ...
            // prettier-ignore
            data: ['标题', '标题', '标题', '标题', '标题', '标题', '标题', '标题', '标题', '标题', '标题'],
          },
        ],
        yAxis: [
          {
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "60%",
            data: [38, 46, 24, 87, 36, 47, 76, 50, 44, 24, 46],
            color: "#1ea5c2",
          },
          {
            name: "Temperature",
            ...
            symbol: "none",
            smooth: true,
            data: [218, 258, 319, 379, 434, 450, 420, 364, 298, 246, 200],
            color: "#5c89e6",
          },
        ],
      });
      ...
      chartFive.setOption({
        ...
        series: [
          {
            data: [
              140, 160, 170, 174, 165, 150, 140, 128, 110, 100, 110, 120, 110,
            ],
            symbol: "none",
            type: "line",
            color: "#13a1bf",
          ...
          {
            data: [
              118, 120, 122, 100, 95, 140, 160, 171, 180, 200, 220, 240, 260,
            ],
            symbol: "none",
            type: "line",
            color: "#5c89e6",
