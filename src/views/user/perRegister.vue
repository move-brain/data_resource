          ...
          <el-scrollbar class="w-[100%]">
            ...
            >
              <el-form-item label="真实姓名：" prop="username">
                <div class="absolute -left-48 flex h-[20px] items-center">
                  <div class="h-[55%] w-[2.5px] bg-[#007f99] mr-1"></div>
                  <span class="font-bold text-sm">个人信息</span>
                </div>
                <el-input
                  v-model="personinfoform.username"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="性别：">
                <el-select
                  v-model="personinfoform.sex"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              <el-form-item label="证件类型：" prop="certificatetype">
                <el-select
                  v-model="personinfoform.certificatetype"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              <el-form-item label="证件号码：" prop="certificatetypecode">
                <el-input
                  v-model="personinfoform.certificatetypecode"
                  placeholder="请输入"
                />
              </el-form-item>
              ...
              <el-form-item label="职称：" prop="professional">
                <el-select
                  v-model="personinfoform.professional"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              <el-form-item label="手机号：" prop="phonenumber">
                <el-input
                  v-model="personinfoform.phonenumber"
                  placeholder="请输入"
                />
              </el-form-item>
            </el-form>
            ...
            >
              <el-form-item label="机构名称：" prop="name">
                ...
                <el-select
                  v-model="organizationinfoform.name"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              <el-form-item label="部门：" prop="department">
                <el-select
                  v-model="organizationinfoform.department"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
