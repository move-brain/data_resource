<template>
  <div class="w-[100%] h-[100%] bg-[#e4e6e9] flex justify-center">
    <div class="w-[70%] h-[90vh] relative max-w-[1000px]">
      <div class="h-[10%] flex justify-center items-center text-2xl font-bold">
        <span>注册账号</span>
      </div>
      <div class="w-[100%] h-[90%] text-sm">
        <div
          class="h-[8%] w-[100%] px-[2%] border-solid bg-white border-b border-[#e1e3e6]"
        >
          <el-row class="h-[100%] flex items-center">
            <el-col :span="6">
              <div class="flex items-center">
                <el-icon class="cursor-pointer" color="#0b849d"
                  ><ArrowLeft
                /></el-icon>
                <span
                  @click="goperRegister"
                  class="text-[#0b849d] cursor-pointer text-xs"
                  >切换个人注册</span
                >
              </div></el-col
            ><el-col :span="12">
            ...
            ><el-col :span="6">
              <div class="flex flex-row-reverse text-xs">
                <span
                  @click="gologin"
                  class="text-[#0b849d] cursor-pointer ml-2"
                  >立即登录</span
                ><span>已有账号?</span>
              </div></el-col
            ></el-row
          ...
          <el-scrollbar class="w-[100%]">
            ...
            >
              <el-form-item label="用户名：" class="w-[100%]" prop="username">
                <div class="absolute -left-48 flex h-[20px] items-center">
                  ...
                  <span class="font-bold text-sm">账户信息</span>
                </div>
                <el-tooltip
                  effect="light"
                ...
                >
                  <template #content>
                    <div
                      class="w-[15.5vw] h-fit flex justify-start flex-col items-center"
                    >
                      <div
                        class="allgo w-[100%] flex justify-start flex-col items-start text-[#09839d]"
                      >
                        <div>
                          <svgicon
                        ...
                        <div class="h-fit w-fit flex">
                          <div class="w-[12px] h-[52px] flex flex-col mr-2">
                            <svgicon
                              style="width: 10px; height: 10px"
                              class="w-[12px] h-[12px]"
                              iconName="icon-kongxinduigou"
              ...
              <el-form-item label="确认密码：" prop="affirmpassword">
                <el-input
                  v-model="accountinfoform.affirmpassword"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="邮箱：" prop="email">
                ...
                >
                  <template #content>
                    <div
                      class="w-[15.5vw] h-fit flex justify-start flex-col items-center text-[#565b5c]"
                    >
                      <span>
              ...
              >
                <el-input
                  placeholder="请输入"
                  v-model="accountinfoform.emailcode"
                  class="havebutton"
                />
            ...
            >
              <el-form-item label="机构中文全称：" prop="FullChinesename">
                <div class="absolute -left-48 flex h-[20px] items-center">
                  <div class="h-[55%] w-[2.5px] bg-[#007f99] mr-1"></div>
                  <span class="font-bold text-sm">机构信息</span>
                </div>
                <el-input
                  v-model="organizationinfoform.FullChinesename"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="机构中文简称：" prop="noFullChinesename">
                <el-input
                  placeholder="请输入"
                  v-model="accountinfoform.noFullChinesename"
                />
              </el-form-item>
              <el-form-item label="机构英文全称：" prop="FullEnglishname">
                <el-input
                  placeholder="请输入"
                  v-model="accountinfoform.FullEnglishname"
                />
              </el-form-item>
              <el-form-item label="机构英文简称：" prop="noFullEnglishname">
                <el-input
                  v-model="organizationinfoform.noFullEnglishname"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="机构性质：" prop="property">
                <el-select
                  v-model="organizationinfoform.property"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              >
                <el-input
                  placeholder="请输入"
                  v-model="accountinfoform.UnifiedSocialCreditIdentifier"
                />
              </el-form-item>
              <el-form-item
                label="机构证件扫描："
                ...
                >
                  <template #content>
                    <div
                      class="w-[15.5vw] h-fit flex justify-start flex-col items-center"
                    >
                      <span class="text-[#565b5c]"
                        >单位的机构法人代表证,
                        正反面扫描成一个文件,上传文件大小不超过5MB</span
                      >
                    </div>
                  </template>
                  <el-upload
                  ...
                  >
                    <template #trigger>
                      <el-button type="primary" color="#007f99" plain
                        >上传文件</el-button
                      >
                    </template>
                    <template #tip>
              ...
              <el-form-item label="法人姓名：" prop="legalname">
                <el-input
                  v-model="organizationinfoform.legalname"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="法人代表身份证号码：" prop="legalid">
                <el-input
                  v-model="organizationinfoform.legalid"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="通讯地址：" prop="contactaddress">
                <el-input
                  v-model="organizationinfoform.contactaddress"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="邮编：" prop="postcode">
                <el-input
                  v-model="organizationinfoform.postcode"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="机构简介：" prop="introductory">
                <el-input
                  v-model="organizationinfoform.introductory"
                  maxlength="300"
                  show-word-limit
                  type="textarea"
                  placeholder="请输入文字"
            ...
            >
              <el-form-item label="真实姓名：" prop="name">
                <div class="absolute -left-48 flex h-[20px] items-center">
                  <div class="h-[55%] w-[2.5px] bg-[#007f99] mr-1"></div>
                  <span class="font-bold text-sm">机构管理员信息</span>
                </div>
                <el-input
                  v-model="organizationadminform.name"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="电话：" prop="phone">
                <el-input
                  v-model="organizationadminform.phone"
                  placeholder="请输入"
                />
              </el-form-item>
              <el-form-item label="证件类型：" prop="certificatetype">
                <el-select
                  v-model="organizationadminform.certificatetype"
                  class="w-[100%]"
                  placeholder="请选择"
                >
                  <el-option
              ...
              <el-form-item label="证件号码：" prop="certificatecode">
                <el-input
                  v-model="organizationadminform.certificatecode"
                  placeholder="请输入"
                />
              </el-form-item>
            </el-form>
        ...
        <div
          class="bg-white h-fit w-[100%] b border-solid border-t border-[#e1e3e6] flex justify-between items-center flex-col"
        >
          <div class="w-[41.25%] min-h-fit flex items-center">
            <el-checkbox />
            <div class="ml-4 text-xs">
              <span>已阅读并同意</span
              ><span class="text-[#007f99] cursor-pointer">
                《国家疾病临床大数据平台用户注册须知》
              </span>
            </div>
          </div>
...
let organizationadminformrules = reactive({
  ...
  certificatetype: [{ required: true, message: "必填项", trigger: "blur" }],
  certificatecode: [{ required: true, message: "必填项", trigger: "blur" }],
});
const upload = ref();
