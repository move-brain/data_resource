<template>
  <div class="w-[100%] h-[100%] bg-[#e4e6e9] flex justify-center items-center">
    <div
      class="w-[38%] h-[55vh] bg-[#ffffff] rounded-lg flex justify-center items-center min-w-min min-h-min max-w-[420px] max-h-[420px]"
    >
      <div class="w-[75%] h-[75%] flex-col">
        <div class="w-[100%] h-fit flex justify-between items-center">
          ...
          <div class="text-[#54a9ba] h-auto flex justify-start items-center">
            <span @click="goperRegister" class="text-xs" style="cursor: pointer"
              >个人注册</span
            >
            <div class="inline-block bg-[#c8cbcc] h-[12px] w-[1px] mx-3"></div>
            <span @click="goorRegister" class="text-xs" style="cursor: pointer"
              >机构注册</span
            >
          </div>
        </div>
        ...
        >
          ...
          <el-form-item class="w-[100%]" prop="isautologin">
            <div
              class="flex justify-between items-center text-[#565b5c] w-[100%]"
            >
              <el-checkbox
                v-model="form.isautologin"
                label="自动登录"
                class="text-xs"
              />
              <div class="text-[#565b5c]">
                ...
                >
                <div
                  class="inline-block bg-[#c8cbcc] h-[12px] w-[1px] mx-3"
                ></div>
                <span
                  class="text-xs"
                  @click="forgetname"
