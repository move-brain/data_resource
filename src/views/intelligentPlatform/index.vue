<template>
  <div
    class="all min-h-full 2xl:min-h-[100vh] flex flex-col h-fit bg-[#f0f2f5]"
  >
    <div
...
let godataplatform = (e) => {
  router.push({ name: "Platformhomepage" });
};
let clickusercenter = () => {
  // router.push({name:''})
};
