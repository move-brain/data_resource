...
const minData = [
  {
    docName: "基因决定的皮肤痣和患癌症的风险",
    docClass: "pdf",
    docData: "2022-03-12 12:00:00",
    docSize: "45MB",
  },
  {
    docName: "吸烟与大脑加速老化之间的关联",
    docClass: "doc",
    docData: "2022-03-12 12:00:00",
    docSize: "56MB",
  },
  {
    docName: "研究伦理法规与个人数据保护之间的争议：十字路口的知情同意",
    docClass: "pdf",
    docData: "2022-03-12 12:00:00",
    docSize: "123MB",
  },
  {
    docName: "柑橘基因相互作用和黑色素瘤风险",
    docClass: "pdf",
    docData: "2022-03-12 12:00:00",
    docSize: "110MB",
  },
...
const getWidth = () => {
  nextTick(() => {
    length.w1 = tablelength.value.clientWidth * 0.3;
...
<template>
  <div style="margin: 2vh 3vw">
    <div style="display: flex; align-items: end">
      ...
      <p style="color: #a9adad">{{ "请在公开发表2周前上传" }}</p>
    </div>
    <div style="display: flex; align-items: end">
