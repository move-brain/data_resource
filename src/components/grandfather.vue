<template>
  <div
    class="w-full h-[33%] bg-use 2xl:h-[25%]"
  ...
  >
    ...
    >
      <div class="h-full w-fit flex items-center">
        ...
        <span class="font-black 2xl:text-base text-sm text-[#ffffff]"
          >工作台</span
        >
      </div>
      <div class="h-full w-fit flex items-center">
  ...
  <div class="bg-[#f0f2f5] h-fit w-[100%]">
    <div
      class="allicon p-[3vw] py-[1vw] w-[25%] 2xl:w-[22%] flex flex-wrap justify-between"
    >
      <div>
        <svgicon
